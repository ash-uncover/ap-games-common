...
var GameSettingAudioMusicVolumeSlider = exports.GameSettingAudioMusicVolumeSlider = function GameSettingAudioMusicVolumeSlider(_ref) {
  ...
  function handleChange(event) {
    var action = _GameSettingsProvider.GameSettingsActions.setAudioMusicVolume(event.value);
    dispatch(action);
  }
  // #endregion

...
exports.GameSettingAudioGameVolumeSlider = void 0;
...
// #region Component
var GameSettingAudioGameVolumeSlider = exports.GameSettingAudioGameVolumeSlider = function GameSettingAudioGameVolumeSlider(_ref) {
  ...
  function handleChange(event) {
    var action = _GameSettingsProvider.GameSettingsActions.setAudioGameVolume(event.value);
    dispatch(action);
  }
  // #endregion

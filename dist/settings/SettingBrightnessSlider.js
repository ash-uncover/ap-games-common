...
exports.SettingBrightnessSlider = void 0;
...
var SettingBrightnessSlider = exports.SettingBrightnessSlider = function SettingBrightnessSlider(_ref) {
  ...
  // #region Events
  function handleChange(brightness) {
    var action = _GameSettingsProvider.GameSettingsActions.setBrightness(brightness);
    dispatch(action);
  }
  // #endregion

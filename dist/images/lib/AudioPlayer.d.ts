...
export declare class AudioPlayer {
    #private;
    constructor(loader?: ImageLoader, volumeManager?: AudioVolumeManager);
    ...
    notify(): void;
    load(path: string | string[], onProgress?: (value: number) => void): Promise<void>;
    mount(path: string | string[], options?: AudioPlayOptions): any;
